                            ...
                            <div class="form-box">
                                ...
                                <div class="form-box__body">
                                    <div class="form-fields">
                                        ...
                                        <select name="package_category_id" class="field select2-select"
                                            ...
                                            @foreach ($categories as $id => $name)
                                                <option value="{{ $id }}"
                                                    {{ old('package_category_id') == $id ? 'selected' : '' }}>
                                                    {{ $name }}</option>
                                            @endforeach
                                        </select>
                                    ...
                                    <div class="form-fields">
                                        ...
                                        <textarea class="editor" name="overview" data-placeholder="Overview" data-error="Overview" data-required>{{ old('overview') }}</textarea>
                                        @error('overview')
                                            <div class="text-danger">{{ $message }}</div>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="form-fields">
                                        ...
                                        <textarea class="editor" name="package_details" data-placeholder="Package Details" data-error="Package Details"
                                            data-required>{{ old('package_details') }}</textarea>
                                    ...
                                    <div class="form-fields">
                                        ...
                                        <textarea class="editor" name="itinerary" data-placeholder="Itinerary" data-error="Itinerary" data-required>{{ old('itinerary') }}</textarea>
                                        @error('itinerary')
                                            <div class="text-danger">{{ $message }}</div>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="form-fields">
                                        ...
                                        <textarea class="editor" name="inclusion" data-placeholder="Inclusion" data-error="Inclusion" data-required>{{ old('inclusion') }}</textarea>
                                        @error('inclusion')
                                            <div class="text-danger">{{ $message }}</div>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="form-fields">
                                        ...
                                        <textarea class="editor" name="exclusion" data-placeholder="Exclusion" data-error="Exclusion" data-required>{{ old('exclusion') }}</textarea>
                                        @error('exclusion')
                                            <div class="text-danger">{{ $message }}</div>
                                        @enderror
                                    </div>
                    ...
                    <div class="col-md-4">
                        <div class="seo-wrapper">
                            ...
                            <div class="form-box">
                                ...
                                <div class="form-box__body">
                                    <x-admin.image-upload name="image" label="Package Image" :required="true" />
                                </div>
                            </div>
                        </div>
                    </div>
