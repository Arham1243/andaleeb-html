                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 mt-4">
                                            <div class="form-fields">
                                                ...
                                                <input data-error="Child Price" type="number" step="0.01"
                                                    name="child_price" class="field" value="{{ old('child_price') }}">
                                                @error('child_price')
                                                    <div class="text-danger">{{ $message }}</div>
                                                @enderror
                                            </div>
                                        ...
                                        <div class="col-md-6 mt-4">
                                            <div class="form-fields">
                                                ...
                                                <input data-error="Infant Price" type="number" step="0.01"
                                                    name="infant_price" class="field" value="{{ old('infant_price') }}">
                                                @error('infant_price')
                                                    <div class="text-danger">{{ $message }}</div>
                                                @enderror
                                            </div>
                                        ...
                                        <div class="col-12 mt-4">
                                            <div class="form-fields">
                                                ...
                                                <textarea data-required data-error="Short Description" name="short_description" class="field" rows="4">{{ old('short_description') }}</textarea>
                                        ...
                                        <div class="col-12 mt-4">
                                            <div class="form-fields">
                                                ...
                                                <textarea data-required data-error="Long Description" name="long_description" class="field" rows="6">{{ old('long_description') }}</textarea>
                        ...
                        <div class="seo-wrapper">
                            <div class="form-box">
                                ...
                                <div class="form-box__body">
                                    ...
                                    <button class="themeBtn ms-auto mt-4" type="submit">Add</button>
