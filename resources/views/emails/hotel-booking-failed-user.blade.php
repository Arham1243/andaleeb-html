    ...
    <center class="wrapper">
        <div class="container">
            ...
            <table width="100%" cellpadding="0" cellspacing="0" class="section-padding border-bottom">
                <tr>
                    <td align="center">
                        ...
                        <p style="font-size: 14px; color: #666666; margin: 10px 0 0 0;">We were unable to complete your
                            hotel booking</p>
                    </td>
                </tr>
            </table>
            ...
            @if (isset($reason) && $reason)
                <table width="100%" cellpadding="0" cellspacing="0" style="padding: 20px 0;">
                    <tr>
                        <td>
                            <div class="error-box">
                                <p style="margin: 0; font-size: 14px; color: #dc3545; font-weight: 600;">Reason:</p>
            ...
            <table width="100%" cellpadding="0" cellspacing="0" class="section-padding border-bottom">
                <tr>
                    <td>
                        <h2 style="font-size: 16px; font-weight: 600; color: #111111; margin: 0 0 15px 0;">What should
                            you do?</h2>
                        <ul style="margin: 0; padding-left: 20px; font-size: 13px; color: #333333;">
                            <li style="margin-bottom: 8px;">Try booking again with a different payment method</li>
            ...
            <table width="100%" cellpadding="0" cellspacing="0" class="section-padding border-bottom">
                <tr>
                    <td align="center">
                        <p style="font-size: 14px; color: #666666; margin: 0 0 10px 0;">Need help? Contact us:</p>
                        <p style="font-size: 14px; color: #111111; margin: 0;">
                            <strong>Phone:</strong> +971 52 574 8986<br />
                            <strong>Email:</strong> info@andaleebtours.com
                        </p>
                    </td>
                </tr>
            </table>
