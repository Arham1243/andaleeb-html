    ...
    <center class="wrapper">
        <div class="container">
                ...
                <tr>
                    <td align="center">
                        ...
                        <p style="font-size: 14px; color: #666666; margin: 10px 0 0 0;">
                            A customer has cancelled their hotel booking.
                        </p>
                    </td>
                </tr>
            </table>

            <table width="100%" cellpadding="0" cellspacing="0" style="padding: 20px 0;" align="center">
                <tr>
                    <td align="center">
                        ...
                        <table width="100%" cellpadding="8" cellspacing="0">
                            ...
                            <tr>
                                  <td width="50%">
                                    ...
                                    <div class="data-text">{{ $booking->created_at ? $booking->created_at->format('d M, Y, h:i A') : 'N/A' }}</div>
                                </td>
                                <td width="50%">
                                    <div class="label">Cancellation Date</div>
                                    <div class="data-text">{{ $booking->cancelled_at ? $booking->cancelled_at->format('d M, Y, h:i A') : 'N/A' }}</div>
                                </td>
                            </tr>
                        </table>
                    </td>
            ...
            <table width="100%" cellpadding="0" cellspacing="0" class="section-padding border-bottom">
                <tr>
                    <td>
                        <h2 style="font-size: 16px; font-weight: 600; color: #111111; margin: 0 0 15px 0;">Customer Information</h2>
                        <table width="100%" cellpadding="8" cellspacing="0">
                            <tr>
                                <td>
            ...
            <!-- Footer -->
            <table width="100%" cellpadding="0" cellspacing="0" style="padding-top: 40px; text-align: center; border-top: 1px solid #f4f4f4;">
                <tr>
                    <td align="center">
                        <p style="font-size: 12px; color: #111111;">© {{ date('Y') }} Andaleeb Travel Agency. All rights reserved.</p>
                    </td>
                </tr>
            </table>
        </div>
