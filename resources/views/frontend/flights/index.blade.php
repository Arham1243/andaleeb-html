...
@section('content')
    <section class="flighs-banner page-header py-5 d-flex align-items-center"
    ...
    <section class="section-flight-offers mar-y py-5 bg-light">
        <div class="container">
            ...
            <div class="row g-4 flights-slider">
