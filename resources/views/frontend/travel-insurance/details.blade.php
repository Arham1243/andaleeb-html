                    ...
                    <div class="col-lg-8">
                        ...
                        <div class="modern-card">
                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-md-3">
                                    ...
                                    <input type="text" name="lead[fname]" class="custom-input" autocomplete="off" required>
                                </div>
                                <div class="col-md-3">
                                    <label class="form-label">Main Contact Email</label>
                                    <input type="email" name="lead[email]" class="custom-input" autocomplete="off" required>
                                </div>
                                <div class="col-md-3">
                                    <label class="form-label">Mobile No.</label>
                                    <input type="text" name="lead[number]" class="custom-input" autocomplete="off" required>
                                </div>
                                <div class="col-md-3">
                        ...
                        <div class="modern-card">
                            ...
                            <div class="row g-3">
                                <div class="col-md-3">
                                    ...
                                    <input type="text" name="adult[fname][]" class="custom-input" autocomplete="off" required>
                                </div>
                                <div class="col-md-3">
                                    <label class="form-label">Last Name</label>
                                    <input type="text" name="adult[lname][]" class="custom-input" autocomplete="off" required>
                                </div>
                                <div class="col-md-3">
                                    <label class="form-label">Date Of Birth</label>
                                    <input type="date" name="adult[dob][]" class="custom-input" autocomplete="off" required>
                                </div>
                                <div class="col-md-3">
                                ...
                                <div class="col-md-3">
                                    ...
                                    <input type="text" name="adult[passport][]" class="custom-input" autocomplete="off" required>
                                </div>
                                <div class="col-md-3">
                                    ...
                                    <select name="adult[nationality][]" class="custom-select" required>
                                        ...
                                        @foreach ($countries as $nationality)
                                            <option value="{{ $nationality->iso_code }}">{{ $nationality->name }}</option>
                                        @endforeach
                                    </select>
                                </div>
                        ...
                        <div class="modern-card">
                            ...
                            <div class="row g-3">
                                <div class="col-md-3">
                                    <label class="form-label">First Name</label>
                                    <input type="text" name="child[fname][]" class="custom-input" autocomplete="off" required>
                                </div>
                                <div class="col-md-3">
                                    <label class="form-label">Last Name</label>
                                    <input type="text" name="child[lname][]" class="custom-input" autocomplete="off" required>
                                </div>
                                <div class="col-md-3">
                                    <label class="form-label">Date Of Birth</label>
                                    <input type="date" name="child[dob][]" class="custom-input" autocomplete="off" required>
                                </div>
                                <div class="col-md-3">
                                    <label class="form-label">Gender</label>
                                ...
                                <div class="col-md-3">
                                    <label class="form-label">Passport No.</label>
                                    <input type="text" name="child[passport][]" class="custom-input" autocomplete="off" required>
                                </div>
                                <div class="col-md-3">
                                    <label class="form-label">Nationality</label>
                        ...
                        <div class="modern-card">
                            ...
                            <div class="row g-3">
                                <div class="col-md-3">
                                    <label class="form-label">First Name</label>
                                    <input type="text" name="infant[fname][]" class="custom-input" autocomplete="off" required>
                                </div>
                                <div class="col-md-3">
                                    <label class="form-label">Last Name</label>
                                    <input type="text" name="infant[lname][]" class="custom-input" autocomplete="off" required>
                                </div>
                                <div class="col-md-3">
                                    <label class="form-label">Date Of Birth</label>
                                    <input type="date" name="infant[dob][]" class="custom-input" autocomplete="off" required>
                                </div>
                                <div class="col-md-3">
                                    <label class="form-label">Gender</label>
                                ...
                                <div class="col-md-3">
                                    <label class="form-label">Passport No.</label>
                                    <input type="text" name="infant[passport][]" class="custom-input" autocomplete="off" required>
                                </div>
                                <div class="col-md-3">
                                    <label class="form-label">Nationality</label>
                        ...
                        <div class="sticky-sidebar">
                            @if($selectedPlanData)
                                @php
                                    ...
                                    $finalPrice = $selectedPlanData['TotalPremiumAmount'] + ($selectedPlanData['TotalPremiumAmount'] * 0.30);
                                ...
                                <label class="plan-card-item plan-card-item--single">
                                    ...
                                    <div class="plan-card-inner">
                                        ...
                                        <div class="plan-cost">
                                            <div class="price-tag">{{ number_format($finalPrice, 2) }} <small>{{ $currencyCode }}</small></div>
